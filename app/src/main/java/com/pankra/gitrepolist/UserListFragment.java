...
import static com.pankra.gitrepolist.UserListActivity.*;
...
//    private static UserListActivity.UserAdapter userAdapter;
    /**
...
//                userAdapter = new UserListActivity().new UserAdapter(getContext(), R.layout.user_list_single, users);
